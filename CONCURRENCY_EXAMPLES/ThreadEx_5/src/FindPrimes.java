		...
		getPrimesJButton.addActionListener(
			new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					/*
						PropertyChangeListener is an interface that defines
						a single method, propertyChange. Every time method 
						setProgress is invoked on a PrimeCalculator, 
						the PrimeCalculator generates a PropertyChangeEvent 
						to indicate that the progress property has changed
					*/
