...
public class ListTest {
	...
	private static void convertToUppercaseStrings( List<String> list )
	{
		...
		{	
			...
			/* 
			 * List method listIterator to get the List ’s 
			 * bidirectional iterator (i.e., one that can traverse 
			 * a List backward or forward). ListIterator is also a 
			 * generic class
			 */
			
			String color = iterator.next(); // get item
			// ListIterator method set to replace the current String
			// to which iterator refers with the String returned by method
			// toUpperCase
